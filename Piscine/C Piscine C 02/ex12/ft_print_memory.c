...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/06 13:52:36 by glancell          #+#    #+#             */
/*   Updated: 2024/11/06 13:52:51 by glancell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	char str[] = "Hello, World! This is a test of ft_print_memory.\n";
	
	// Print the memory dump of the string
